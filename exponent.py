# Arithemetic Operators and expressions
# Challenge: Perform Calculations on User Input
# Write a program called exponent.py that receives two numbers from the user and displays the first number raised to the power of the second number. Here’s sample run of what the program should look like, including example input from the user:
# Enter a base: 1.2
# Enter an exponent: 3
